        ...
        <div class="meme-row good">
          ...
          <div class="meme-content">
            ...
            <div class="meme-points good-points">
              <span>- 포토샵, Canva 등 수단과 방법을 가리지 말고 한눈에 쏙 들어오게 가공</span>
    ...
    content: `
      ...
      <div class="stage3-page" id="s3_page_5">
        <div class="carousel-section">
          ...
          ${createCarousel(['img/event/3.webp', 'img/event/4.webp', 'img/event/5.webp', 'img/event/9.png'])}
          <div class="highlight-box" style="margin-top: 15px; font-size: 0.95rem; line-height: 1.6;">
      ...
      <div class="tc-skill-container">
        ...
        <div class="tc-skill-block">
          ...
          <p class="tc-skill-desc">
            법정 보건관리자 요건을 충족하는 <strong>간호사 면허</strong> 보유. 크런치로 깎인 동료들의 체력과 방어력을 관리하여 주말농장행을 방지하는 <strong>사내 전담 힐러</strong>로 활약한다.
          </p>
        ...
        <div class="tc-skill-block">
          ...
          <div class="tc-skill-stats">
            <div class="tc-stat-label" style="flex-direction:column;"><span>Lv.5</span><span style="font-size:0.65em;opacity:0.7;">/10</span></div>
            <div class="tc-stat-val">
              전달력: <span class="tc-highlight">보충수업 및 학원 강사 출신의 탁월한 진행력</span><br>
              콘텐츠 툴: <span class="tc-highlight">Premiere Pro, Photoshop 등</span><br>
        ...
        <div class="tc-skill-block">
          ...
          <div class="tc-skill-stats">
            <div class="tc-stat-label">Lv. 성장중</div>
            <div class="tc-stat-val">
